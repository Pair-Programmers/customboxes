...
@section('title-meta')
    <title>{{ env('APP_NAME', 'Admin') }} | industry Create</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="POST" action="{{ route('admin.industry.update', $industry) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="" name="summary" type="text"  class="form-control"
                                            value="{{ $industry->summary }}">
                                        @error('summary')
                                            <span class="help-block m-b-none">Summary Error</span>
                                        @enderror
                                    </div>
