...
class IndustrySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $industry_names = [
            ...
            ['Jewelry Boxes','---', true],
            ['Rigid Boxes', 'Are you in the business of shipping your products globally and want something unique to make sure your product stays safe during transit? If so, then we at Custom Boxes US provide the best packaging solution for you "Custom Rigid Boxes." Contact us!', true],
            ['Apparel Boxes','---', true],
            ['Sports Boxes', '---', true],
